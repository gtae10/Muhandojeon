export default function Footer() {
  return (
    <>
      ...
      <p className="fixed bottom-2 right-3 sm:bottom-3 sm:right-4 max-w-[200px] text-right text-[11px] leading-snug text-[var(--color-muted)]/80 pointer-events-none z-10">
